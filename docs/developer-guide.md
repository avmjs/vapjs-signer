...
All information regarding contributing to and progressing `vapjs-signer` module can be found in this document.
...
```
git clone http://github.com/vapjs/vapjs-signer
npm install
```
...
Please help better the ecosystem by submitting issues and pull requests. We need all the help we can get to build the absolute best linting standards and utilities. We follow the AirBNB linting standard. Please read more about contributing to `vapjs-signer` in the `.github/CONTRIBUTING.md`.
